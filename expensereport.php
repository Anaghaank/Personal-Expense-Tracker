    ...
    <div class="d-flex" id="wrapper">
        <div class="border-right" id="sidebar-wrapper">
            ...
            <div class="list-group list-group-flush">
                ...
                <a href="expensereport.php" class="list-group-item list-group-item-action sidebar-active"><span
                    ...
                    <div class="col-md-6">
                        <form method="POST" action="">
                            <div class="form-group row" style="padding-top: 25px;">
                                <label for="report_type" class="col-sm-6 col-form-label"><b>Select Report
                                        Type:</b></label>
                                <div class="col-md-6">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input type="date" class="form-control col-sm-12"
                                        value="<?php echo date('Y-m-d'); ?>" name="start_date" id="start_date" required>
                                </div>
                            </div>
                            <div class="form-group row">
                            ...
                            <div class="form-group row">
                                <div class="col-md-12 text-right">
                                    <button type="submit" class="btn btn-lg btn-block btn-success"
                                        style="border-radius: 0%;">Generate Report</button>
                                </div>
                            </div>
